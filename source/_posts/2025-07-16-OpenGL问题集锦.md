...
```
当纹理的内部格式和读取的format并不完全对应时，各个分量的填充处理如表格所示：
{% img glGetTexImage /images/OpenGL问题集锦/glGetTexImage.jpeg %}

> 表格来源[glspec46.core.pdf](https://registry.khronos.org/OpenGL/specs/gl/glspec46.core.pdf), P249